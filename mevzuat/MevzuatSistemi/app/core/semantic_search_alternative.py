...
class SimpleTfIdfSemanticSearch:
    ...
    def _load_from_cache(self) -> bool:
        ...
        try:
            if (self.vectorizer_path.exists() and 
                self.vectors_path.exists() and 
                self.ids_path.exists()):
                ...
                self.logger.info(f"TF-IDF modeli yüklendi: {len(self.document_ids)} dokuman")
                return True
    ...
    def _train_model(self, documents: List[Dict[str, Any]]):
        ...
        try:
            ...
            self.logger.info(f"TF-IDF modeli eğitildi: {len(texts)} dokuman, {self.document_vectors.shape[1]} özellik")
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'feature_count': self.document_vectors.shape[1] if self.document_vectors is not None else 0,
            'max_features': self.max_features,
            'ngram_range': self.ngram_range
        }
