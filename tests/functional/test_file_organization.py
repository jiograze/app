    ...
    try:
        ...
        for test_file in test_files:
            ...
            if result.get("success"):
                ...
                print(
                    f"  Belge türü: {result['classification'].get('document_type', 'N/A')}"
                )
                print(f"  Başlık: {result['classification'].get('title', 'N/A')}")
                print(
                    f"  Kanun No: {result['classification'].get('law_number', 'N/A')}"
                )
                ...
                if "organization" in result:
                    ...
                    if org.get("success"):
                        ...
                        print(
                            f"  Hedef klasör: {org.get('organized_structure', 'N/A')}"
                        )
